...
class Template08d1ddd0cc extends Latte\Runtime\Template
{
	public $blocks = [
...
<head>
	...
	<script type="text/javascript" src="<?php echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($basePath)) /* line 10 */ ?>/js/bootstrap.js"></script>
