...
class Template07ff11f175 extends Latte\Runtime\Template
{
	public $blocks = [
	...
	{
		extract($this->params);
		if (isset($this->params['error'])) trigger_error('Variable $error overwritten in foreach on line 19');
...
<?php
		...
		foreach ($form->errors as $error) {
			if ($form->hasErrors()) {
?>		<div class="errors alert alert-warning mt-3">
			<?php echo LR\Filters::escapeHtmlText($error) /* line 20 */ ?>
